...
var MESAS = [
  { id:'premium',    nombre:'Mesa Premium',       tipo:'Clásica · elegante',   capacidad:200, desc:'Vajilla de línea premium, dorados y blanco impecable.',                fotos:['assets/05-mesas-montadas/premium/premium-1.jpg','assets/05-mesas-montadas/premium/premium-2.jpg'], productos:['plato-de-sitio-perla-oro','plato-de-sitio-satin-oro','premium','cuberteria-oro-premium','copas-spirit','copas-adagio'] },
  { id:'romantic',   nombre:'Mesa Romantic',      tipo:'Romántica · jardín',   capacidad:20,  desc:'Flores en tonos rosados, cristal de color y dorados cálidos.',         fotos:['assets/05-mesas-montadas/romantic/romantic-1.jpeg','assets/05-mesas-montadas/romantic/romantic-2.jpg','assets/05-mesas-montadas/romantic/romantic-3.jpg','assets/05-mesas-montadas/romantic/romantic-4.jpg','assets/05-mesas-montadas/romantic/romantic-5.jpg'], productos:['plato-de-sitio-perla-oro','perla-rosa','vogt','minerva','cuberteria-oro-premium','copas-de-color'] },
  { id:'blue-white', nombre:'Mesa Blue & White',  tipo:'Fresca · atemporal',   capacidad:80,  desc:'Azul y blanco, un clásico que siempre funciona.',                      fotos:['assets/05-mesas-montadas/blue-white/blue-white-1.jpg','assets/05-mesas-montadas/blue-white/blue-white-2.jpg'], productos:['plato-de-sitio-satin-oro','bw-opulence','bw-rockwood','bw-lozalit','bw-gural','bw-printemps','bw-british-anchor','bw-johnson','bw-verbano','bw-kent','bw-saxonia','bw-tsuji-old','bw-tsuji-flora','bw-country','bw-bavaria','cuberteria-ny','copas-de-color','copas-borde-oro'] },
  { id:'country',    nombre:'Mesa Country',       tipo:'Campestre · natural',  capacidad:80,  desc:'Fibras naturales, verdes y texturas para un evento al aire libre.',    fotos:['assets/05-mesas-montadas/country/country-1.jpg','assets/05-mesas-montadas/country/country-2.jpg','assets/05-mesas-montadas/country/country-3.jpg'], productos:['plato-de-sitio-yute','plato-de-sitio-palma','relieve-blanco','cuberteria-oro-premium','copas-spirit'] },
  { id:'luxury',     nombre:'Mesa Luxury',        tipo:'Lujo · statement',     capacidad:24,  desc:'Dorados, cristal y detalles de alto impacto.',                         fotos:['assets/05-mesas-montadas/luxury/luxury-1.jpg','assets/05-mesas-montadas/luxury/luxury-2.jpg','assets/05-mesas-montadas/luxury/luxury-3.jpg'], productos:['plato-de-sitio-perla-oro','luxury-white','luxury-gold','cuberteria-oro-premium','copas-de-color'] }
];
